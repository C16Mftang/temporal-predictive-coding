...
parser.add_argument('--flip-nat', type=str, default='False', choices=['False', 'True'],
                    help='whether to horizontally flip the natural movies to create opposite directions of motion')
...
def main(args):
    ...
    if STA == 'False':
        ...
        if datapath == 'blobs':
            ...
            train = get_nat_movie(datapath, train_size, seq_len, args.flip_nat).reshape((-1, seq_len, h, w))
